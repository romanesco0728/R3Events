...
""";
                        ...
                        // In an interpolated raw string the double-brace placeholders become single-brace text (e.g. "{eventName}"),
                        // so replace single-brace placeholders with actual values.
                        var method = methodTemplate
                            .Replace("{eventName}", eventName)
                            .Replace("{observableElementType}", observableElementType)
                            .Replace("{targetTypeDisplay}", targetTypeDisplay);
...
""";
                        ...
                        var method = methodTemplate
                            ...
                            .Replace("{observableElementType}", observableElementType)
                            .Replace("{targetTypeDisplay}", targetTypeDisplay)
                            .Replace("{delegateTypeDisplay}", delegateTypeDisplay)
                ...
                // Using placement: when inside a namespace block, indent usings; otherwise place them at top-level.
                var usingSystemLine = classNamespace.Length > 0 ? "    using global::System;\n    using global::System.Threading;\n" : "using global::System;\nusing global::System.Threading;\n";
                var usingComponentLine = needsComponentModel
                    ? (classNamespace.Length > 0 ? "    using global::System.ComponentModel;\n" : "using global::System.ComponentModel;\n")
                    : string.Empty;
...
{
{{usingSystemLine}}{{usingComponentLine}}    {{classAccessibility}} static partial class {{classSymbol.Name}}
    {
{{methodsBuilder}}
    }
}
