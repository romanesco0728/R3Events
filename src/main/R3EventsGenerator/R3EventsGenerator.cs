...
""";
        context.AddSource("R3Events.R3EventAttribute.g.cs", SourceText.From(code, Encoding.UTF8));
    }
...
""";
        context.AddSource("R3Events.R3EventAttribute_T.g.cs", SourceText.From(code, Encoding.UTF8));
    }
